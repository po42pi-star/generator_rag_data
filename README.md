...
┌─────────────────────────────────────────────────────────┐ │ RAG SYSTEM │ ├─────────────────────────────────────────────────────────┤ │ │ │ 1️⃣ RETRIEVAL (Извлечение) │ │ Поиск релевантных данных в векторной базе │ │ ↓ │ │ 2️⃣ AUGMENTATION (Дополнение) │ │ Добавление контекста к запросу │ │ ↓ │ │ 3️⃣ GENERATION (Генерация) │ │ Формирование ответа на основе найденного │ │ │ └─────────────────────────────────────────────────────────┘
