...
[Особенности](#-особенности-системы) • [Установка](#-быстрый-старт) • [Использование](#-использование-rag-системы) • [JSON API](#-использование-json-данных-в-других-проектах) • [Заключение](#-заключение) • [Контакты](#-контакты)
